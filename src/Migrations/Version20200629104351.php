 ...
 */
final class Version20200629104351 extends AbstractMigration
{
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE doctrine_migration_versions (version VARCHAR(14) CHARACTER SET utf8mb4 NOT NULL COLLATE `utf8mb4_unicode_ci`, executed_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', PRIMARY KEY(version)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
        $this->addSql('ALTER TABLE bphs_health_facility DROP FOREIGN KEY FK_3C790A24B03A8386');
        $this->addSql('ALTER TABLE bphs_health_facility DROP FOREIGN KEY FK_3C790A24896DBBDE');
